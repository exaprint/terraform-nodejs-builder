...
#      && npm install -g underscore \
      && curl -LO https://releases.hashicorp.com/terraform/0.11.15/terraform_0.11.15_linux_amd64.zip \
      ...
      && rm consul_0.8.5_linux_amd64.zip terraform_0.11.15_linux_amd64.zip \
      && mkdir -p /root
